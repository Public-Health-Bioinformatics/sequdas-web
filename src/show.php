        ...
        <div class="row">
            <div class="col-sm-12">
	            ...
	            <?php
                    ...
                    <table align="center">
                        <tbody>
                            <tr>
                                <td>
                                    <a href="#" onclick="QCREPORT(event, 'QC3')"> <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_Intensity-by-cycle_Intensity.png"><a/>
                                </td>
                                <td>
                                    <a href="#" onclick="QCREPORT(event, 'QC6')"> <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-histogram.png"><a/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" onclick="QCREPORT(event, 'QC7')"> <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-heat-map.png"><a/>
                                </td>
                                <td>
                                    <a href="#" onclick="QCREPORT(event, 'QC8')">  <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_sample-qc.png"><a/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
	            ...
	            <?php
                    ...
                    <div align="center">
                        <a href="#" onclick="QCREPORT(event, 'QC1')">  <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_Intensity-by-cycle_Intensity.png"></a>
                    </div> 
	            ...
	            <?php
                    ...
                    <p>Plot by Lane</p>
                    <div align="center">
                        <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_ClusterCount-by-lane.png">
                    </div>
...
<div id="QC5" class="tabcontent">
    ...
    <div align="center">
        <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_flowcell-Intensity.png">
    </div>
...
<div id="QC6" class="tabcontent">
    ...
    <div align="center">
        <a href="#" onclick="QCREPORT(event, 'QC1')"> <img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-histogram.png"></a>
    </div>
...
<div id="QC7" class="tabcontent">
    ...
    <p>Qscore Heatmap</p>
    <div align="center">
        <a href="#" onclick="QCREPORT(event, 'QC1')"><img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_q-heat-map.png"></a>
    </div>
...
<div id="QC8" class="tabcontent">
    ...
    <p>Sample QC</p>
    <div align="center">
        <a href="#" onclick="QCREPORT(event, 'QC1')"><img src="./img/<?php echo $_GET["name"]?>/<?php echo $_GET["name"]?>_sample-qc.png"></a>
    </div>
